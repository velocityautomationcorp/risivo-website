    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="video-container">
                ...
                <script src="https://fast.wistia.com/embed/crxghlwc2s.js" async type="module"></script>
                <style>
                    wistia-player[media-id='crxghlwc2s']:not(:defined) { 
                        background: center / contain no-repeat url('https://fast.wistia.com/embed/medias/crxghlwc2s/swatch'); 
                        display: block; 
                        filter: blur(5px); 
                        padding-top:56.25%; 
                    }
                ...
                <wistia-player media-id="crxghlwc2s" aspect="1.7777777777777777"></wistia-player>
            </div>
