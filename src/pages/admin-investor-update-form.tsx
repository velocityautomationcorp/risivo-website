...
<head>
    ...
    <style>
        ...
        .platform-checkbox:hover { border-color: #10b981; }
        .platform-checkbox.checked { border-color: #10b981; background: #d1fae5; }
        ...
        .timing-option:hover { border-color: #10b981; }
        .timing-option input { margin-right: 8px; }
        .timing-label { font-weight: 500; }
        .timing-desc { display: block; font-size: 12px; color: #666; margin-top: 4px; margin-left: 26px; }
        ...
        .no-platforms a { color: #10b981; font-weight: 600; }
                        ...
                        <div class="form-group">
                            ...
                            <div class="timing-options">
                                <label class="timing-option">
                                    ...
                                    <span class="timing-label">Post Immediately</span>
                                    <span class="timing-desc">When update is published</span>
                                </label>
                                <label class="timing-option">
                                    <input type="radio" name="post_timing" value="scheduled">
                                    <span class="timing-label">Schedule for Later</span>
                                    <span class="timing-desc">Choose date and time</span>
                                </label>
                            </div>
                        </div>
