...
export const AdminInvestorCategoriesPage = (admin: any, categories: any[] = []) => {
    ...
    if (categories.length > 0) {
        const rows = categories.map(cat => `
            <tr>
                ...
                <td>
                    <span class="color-badge" style="background-color: ${cat.color || '#10b981'}"></span>
                    <code>${cat.color || '#10b981'}</code>
                </td>
...
<head>
    ...
    <title>Investor Update Categories - Risivo Admin</title>
...
<body>
    ...
    <div class="container">
        ...
        <h1 class="page-title">🏷️ Investor Update Categories</h1>
        <p class="page-subtitle">Manage categories for investor updates</p>
        ...
        <div class="modal-content">
            ...
            <form id="categoryForm" onsubmit="saveCategory(event)">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="categoryName" name="name" class="form-input" required placeholder="e.g., Financial Update">
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="color" id="categoryColor" name="color" class="form-input" value="#10b981">
                    </div>
                </div>
    ...
    <script>
        ...
        function openModal(category = null) {
            ...
            document.getElementById('categoryColor').value = category?.color || '#10b981';
        ...
        async function saveCategory(event) {
            ...
            try {
                const url = editingId 
                    ? \`/api/admin/investor-categories/\${editingId}\`
                    : '/api/admin/investor-categories';
        ...
        async function deleteCategory(id) {
            ...
            try {
                const response = await fetch(\`/api/admin/investor-categories/\${id}\`, {
                    method: 'DELETE'
                });
