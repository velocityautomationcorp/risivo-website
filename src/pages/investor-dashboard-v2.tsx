...
<body>
    <div class="dashboard-container">
        ...
        <div id="founderVideoModal" class="video-modal" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.9); z-index: 1000; align-items: center; justify-content: center;">
            <div style="position: relative; width: 90%; max-width: 900px; background: #000; border-radius: 16px; overflow: hidden;">
                <button onclick="closeFounderVideoModal()" style="position: absolute; top: 15px; right: 15px; background: rgba(255,255,255,0.3); border: none; color: white; width: 40px; height: 40px; border-radius: 50%; cursor: pointer; font-size: 20px; z-index: 10;">✕</button>
                <div style="padding: 20px;">
                    <h3 style="color: white; margin-bottom: 15px; font-size: 20px;">🎬 Welcome from Our Founder</h3>
                    <div class="wistia_responsive_padding" style="padding:56.25% 0 0 0;position:relative;">
                        <div class="wistia_responsive_wrapper" style="height:100%;left:0;position:absolute;top:0;width:100%;">
                            <iframe src="https://fast.wistia.net/embed/iframe/n7wm9obini?seo=true&videoFoam=true" title="Welcome from Our Founder" allow="autoplay; fullscreen" allowtransparency="true" frameborder="0" scrolling="no" class="wistia_embed" name="wistia_embed" style="width:100%;height:100%;border-radius:8px;" id="founderVideoIframe"></iframe>
                        </div>
                    </div>
    ...
    <script>
        ...
        function closeFounderVideoModal() {
            ...
            // Stop Wistia video by reloading iframe src
            const iframe = document.getElementById('founderVideoIframe');
            if (iframe) {
