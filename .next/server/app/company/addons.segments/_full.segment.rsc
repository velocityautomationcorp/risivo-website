...
6:["$","$1","c",{"children":[["$","div",null,{"className":"space-y-6","children":[["$","div",null,{"children":[["$","h1",null,{"className":"text-3xl font-bold text-gray-900","children":"Add-ons"}],["$","p",null,{"className":"mt-2 text-sm text-gray-600","children":"Extend your CRM with powerful integrations"}]]}],["$","div",null,{"className":"bg-white shadow-sm rounded-lg border border-gray-200 p-12 text-center","children":[["$","span",null,{"className":"text-6xl mb-4 block","children":"🧩"}],["$","h2",null,{"className":"text-2xl font-bold text-gray-900 mb-2","children":"Add-ons Marketplace"}],["$","p",null,{"className":"text-gray-600","children":"This page is coming soon..."}]]}]]}],null,["$","$L10",null,{"children":["$","$11",null,{"name":"Next.MetadataOutlet","children":"$@12"}]}]]}]
